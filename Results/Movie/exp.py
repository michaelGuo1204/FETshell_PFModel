...
def animate_frame(i,data_sequence):
    ...
    fig_main.suptitle(f"Simulation of FUS-ERG-DNA condensates: time step {i*20}")
    fig_main.tight_layout()
    return fig_main
...
solver = Solver(para,init_order,logger=None,target_region="eta-phi",DNA=True,crit=0.15)
solver.initialize()
...
ani.save('animation_exp.mp4', writer=ffwriter)
